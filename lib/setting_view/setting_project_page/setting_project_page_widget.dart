...
class SettingProjectPageWidget extends StatefulWidget {
  const SettingProjectPageWidget({super.key});

  @override
  State<SettingProjectPageWidget> createState() =>
      _SettingProjectPageWidgetState();
}

class _SettingProjectPageWidgetState extends State<SettingProjectPageWidget> {
  late SettingProjectPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingProjectPageModel());
